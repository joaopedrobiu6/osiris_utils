...
class DatabaseCreator:
    ...
    def _input_database(self, name):
        ...
        # First derivatives
        self.simulation[self.species].add_diagnostic(Derivative_Diagnostic(self.simulation[self.species]["nT11"], "x1"), "dnT11_dx1")
        self.simulation[self.species].add_diagnostic(Derivative_Diagnostic(self.simulation[self.species]["nT12"], "x2"), "dnT12_dx2")
    ...
    def _output_database(self, name):
        ...
        self.ar = AnomalousResistivity(self.simulation, self.species, config=conf)
